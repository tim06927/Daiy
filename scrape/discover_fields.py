...
from scrape.html_utils import extract_current_page, extract_next_page_url, is_product_url
...
def print_results(results: Dict) -> None:
    ...
    print(f"    FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE CASCADE")
    print(");")
